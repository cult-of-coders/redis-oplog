...
export default class RedisSubscriber {
    ...
    constructor(publicationEntry, strategy) {
        ...
        this.channels = this.observableCollection.channels;
        ...
        if (strategy === Strategy.DEDICATED_CHANNELS) {
            if (this.observableCollection.selector._id) {
                this.observableCollection.__containsOtherSelectorsThanId = _.keys(this.observableCollection.selector) > 1;
            }
        }
