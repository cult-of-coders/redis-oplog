...
const { REDIS_URI, REDIS_PORT, REDIS_HOST, redis_sentinel_master_set_name } = process.env
...
const REDIS_SENTINEL_MASTER_NAME = redis_sentinel_master_set_name;
...
if (REDIS_SENTINEL_MASTER_NAME)
    Config.redis.master_name = REDIS_SENTINEL_MASTER_NAME;

if (DB_NAME !== '')
    Config.redis.db_name = DB_NAME;
