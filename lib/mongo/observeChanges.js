...
export default function(cursorDescription, ordered, callbacks) {
    ...
    Meteor._noYieldsAllowed(function() {
        ...
        if (_.has(self._observeMultiplexers, observeKey)) {
            ...
            if (multiplexer.observeDriver.options._suppress_initial !== callbacks.observeDriver.options._suppress_initial) {
              multiplexer.observeDriver.options._suppress_initial = callbacks.observeDriver.options._suppress_initial;
              if (!multiplexer.observeDriver.options._suppress_initial) {
