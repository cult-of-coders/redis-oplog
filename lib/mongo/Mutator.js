...
export default class Mutator {
    static insert(Originals, data, _config) {
        ...
        const docId = Originals.insert.call(this, data, callback || config);
    ...
    static update(Originals, selector, modifier, _config) {
        ...
        config = getMutationConfig(this._name, _config);
        ...
        const result = Originals.update.call(this, selector, modifier, callback || config);
