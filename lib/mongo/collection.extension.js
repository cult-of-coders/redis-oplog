...
export default () => {
    ...
    _.extend(Mongo.Collection.prototype, {
         ...
         * @returns {*}
         */
        insert(data, config, col2Callback) {
            return Mutator.insert.call(this, Originals, data, config, col2Callback);
        },
         ...
         * @returns {*}
         */
        update(selector, modifier, config, callback, col2Callback) {
            return Mutator.update.call(this, Originals, selector, modifier, config, callback, col2Callback);
        },
