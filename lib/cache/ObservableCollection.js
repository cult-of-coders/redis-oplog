...
export default class ObservableCollection {
    ...
    isEligibleByDB(doc) {
        if (this.testDocEligibility) {
            ...
            // console.log('isEligibleByDB', this.selector, doc,this.store[doc._id],obj)
            // var bool = this.testDocEligibility.documentMatches(obj).result;
            // console.log('isEligibleByDB',bool)
            return true;
